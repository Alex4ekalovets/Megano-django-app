...
from api.models import Product, Category, ProductImage, Specification
    ...
    def handle(self, *args, **options):
        ...
        for item in items:
            ...
            for image in item['images']:
                ...
                product_images.append(ProductImage(product=product, src=image_path, alt=image['alt']))
                shutil.copy(source_path, destination_path)
            ProductImage.objects.bulk_create(product_images)
            Specification.objects.bulk_create(
                [Specification(product=product, name=parameter['name'], value=parameter['value'])
